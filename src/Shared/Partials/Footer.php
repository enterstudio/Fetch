		...
		<div class="row">
			<div class="col m4 s12">
				...
				<p class="grey-text text-lighten-4">
					Fetch is currently a work in progress. Things may change unexpectedly or without warning.
				</p>
			</div>
			<div class="col m4 s12">
				<h5 class="white-text">Open Source on GitHub</h5>
				<p class="grey-text text-lighten-4">
					It's easy to contribute to Fetch &ndash; just send a pull request. Any knowledge of PHP helps us expand and
					become better.
				</p>
				<a href="https://github.com/DigiTechs/Fetch" target="_blank" alt="On GitHub" class="waves-effect waves-light btn <?= FETCH_PRIMARY_COLOR ?> darken-1">GitHub</a>
			</div>
			<div class="col m4 s12">
